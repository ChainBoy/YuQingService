package com.vrv.nj.mail.service.impl;
...
import com.vrv.nj.domain.mail.MyAuthenticator;
...
public class MailMessageService implements IMailMessageService
{
    ...
    @Override
    public String send(MailSenderInfo mailSenderInfo)
        throws MessagingException
    {
        if (sendHtmlMail(mailSenderInfo))
        {
            return ReturnMessage.SEND_SUCCESS;
        }
        return ReturnMessage.SEND_FAIL;
